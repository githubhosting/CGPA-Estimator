      ...
      <Card sx={{ minWidth: 275, mt: 3, mb: 2 }}>
        <CardContent>
          ...
          <Typography variant="body2">
            If you have an idea related to a product or service, you can submit
            it. by clicking on the submit button below. Our faculty will review
            it and If it is good enough, it will be published.
          </Typography>
        </CardContent>
        <CardActions>
          <Button
